...
public class LoadArffFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Instances data1 = DataSource
                .read("C:\\Program Files\\Weka-3-6\\data\\weather.nominal.arff");
        System.out.println("\n数据集内容：");
        ...
        loader.setSource(new File("C:\\Program Files\\Weka-3-6\\data\\weather.nominal.arff"));
