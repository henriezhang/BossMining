package com.webdev.serialization;
...
public class HeaderSerialization {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("数据头信息！\n");
        System.out.println(header);
        SerializationHelper.writeAll("C:\\Program Files\\Weka-3-6\\data\\j48.model",
        ...
        // 反序列化模型
        Object o[] = SerializationHelper.readAll("C:\\Program Files\\Weka-3-6\\data\\j48.model");
